        ...
        <div class="modal" id="MyModal">
            ...
            <div class="modal-content" id="modal-content-editar">
                ...
                <form action="" onsubmit="validacion_modificadorJS(); return false;">
                    ...
                    <select name="list" id="tipo_mod" class="input">
                    ...
                    <input type="file" name="foto_principal_mod" id="foto_principal_mod" class="input">
                    <input type="file" name="foto2_mod" id="foto2_mod" class="input">
                    <input type="file" name="foto3_mod" id="foto3_mod" class="input">
                    <input type="file" name="foto4_mod" id="foto4_mod" class="input">
                    <input type="file" name="foto5_mod" id="foto5_mod" class="input">
            ...
            <div class="modal-content" id="modal-content-crear">
                ...
                <form action="" onsubmit="validacion_creadorJS(); return false;">
                    ...
                    <p class="texto_form">Tipo Restaurante</p>
                    <select name="list" id="tipo_crear" class="input">
                        <option value="Italiana">Italiana</option>
                        <option value="Española">Española</option>
                        <option value="Mexicana">Mexicana</option>
                        <option value="Arabe">Arabe</option>
